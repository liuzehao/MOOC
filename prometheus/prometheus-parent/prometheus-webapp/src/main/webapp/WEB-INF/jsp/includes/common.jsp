...
<link rel="stylesheet" type="text/css" href="<c:url value="/js/alertMsg.css"/>" />
<link href="<c:url value="/js/zTree3.5/css/zTreeStyle/zTreeStyle.css"/>" rel="stylesheet" type="text/css"/>
<!-- END THEME STYLES -->
...
<script src="<c:url value="/js/alertMsg.js"/>" type="text/javascript"></script>
<script type="text/javascript" src="<c:url value="/js/zTree3.5/js/jquery.ztree.core-3.5.min.js"/>"></script>
<script type="text/javascript" src="<c:url value="/js/zTree3.5/js/jquery.ztree.excheck-3.5.min.js"/>"></script>
<script type="text/javascript" src="<c:url value="/js/zTree3.5/js/jquery.ztree.exedit-3.5.min.js"/>"></script><!-- END CORE PLUGINS -->
<!-- END CORE PLUGINS -->
...
<script type="text/javascript" src="<c:url value="/assets/global/plugins/bootbox/bootbox.min.js"/>"></script>

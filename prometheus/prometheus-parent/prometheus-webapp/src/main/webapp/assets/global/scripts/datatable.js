...
var Datatable = function () {
    ...
    var tabthalloptions;  // main options
    ...
    var countSelectedRecords = function() {
        ...
        var text = tabthalloptions.dataTable.oLanguage.sGroupActions;
        if (selected > 0) {
    ...
    return {
        ...
        init: function (options) {
                    ...
                    "fnServerData": function ( sSource, aoData, fnCallback, oSettings ) {
                      oSettings.jqXHR = $.ajax( {
                        ...
                        "success": function(res, textStatus, jqXHR) {
                            ...
                            if (res.sStatus) {
                                if (tabthalloptions.resetGroupActionInputOnSuccess) {
                            ...
                            if (tabthalloptions.onSuccess) {
                                tabthalloptions.onSuccess.call(undefined, the);
                            }
                            fnCallback(res, textStatus, jqXHR);
                        },
                        "error": function() {
                            if (tabthalloptions.onError) {
                                tabthalloptions.onError.call(undefined, the);
                            }
                            Metronic.alert({type: 'danger', icon: 'warning', message: tabthalloptions.dataTable.oLanguage.sAjaxRequestGeneralError, container: tableWrapper, place: 'prepend'});
            ...
            table.on('click', '.filter-submit', function(e){
                ...
                the.setAjaxParam("sAction", tabthalloptions.filterApplyAction);
            ...
            table.on('click', '.filter-cancel', function(e){
                ...
                the.clearAjaxParams();              
                the.setAjaxParam("sAction", tabthalloptions.filterCancelAction);
                dataTable.fnDraw();
            });
        },

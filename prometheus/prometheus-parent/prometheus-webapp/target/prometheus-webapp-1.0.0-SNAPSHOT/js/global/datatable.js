...
var DataTable = function () {
    ...
    var countSelectedRecords = function () {
        ...
        var text = tabthalloptions.dataTable.oLanguage.groupActions;
        if (selected > 0) {
                    ...
                    "ajax": function (data, fnCallback, oSettings) {
                        ...
                        oSettings.jqXHR = $.ajax({
                            ...
                            "success": function (res, textStatus, jqXHR) {
                                if (tabthalloptions.dataFormat) {
                                    tabthalloptions.dataFormat(res);
                                }
                            ...
                            "error": function () {
                                if (tabthalloptions.onError) {
                                    tabthalloptions.onError.call(the);
                                }
                                Metronic.alert({type: 'danger', icon: 'warning', message: tabthalloptions.dataTable.language.ajaxRequestGeneralError, container: tableWrapper, place: 'prepend'});
...
//                the.addAjaxParam("sAction", tabthalloptions.filterCancelAction);
                dataTable.fnDraw();
                the.clearAjaxParams();
            });
        },
